...
@Component({
  ...
  templateUrl: './saved-pokemons-modal.component.html',
  styleUrls: ['./saved-pokemons-modal.component.css'],
  imports: [
    CommonModule, 
    MatDialogModule,
    MatButtonModule
...
export class SavedModalComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public data: { saved: Pokemon[] }) {}
